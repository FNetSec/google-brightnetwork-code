...
class VideoPlayer:
    ...
    def show_all_videos(self):
        ...
        for video in all_videos:
            ...
            if video.is_flagged():
                print(f" - FLAGGED (reason: {video.get_flag_reason()})")
            else:
                print()
    ...
    def continue_video(self):
        ...
        elif self._video_library.is_video_paused() is False:
    ...
    def show_playing(self):
        ...
        if self._video_library.is_video_paused():
            print(" - PAUSED")
        else:
            print("")
